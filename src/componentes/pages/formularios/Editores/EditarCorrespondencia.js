...
export const EditarCorrespondencia = () => {
  ...
  return (
    <div>
      <main className='main_registro_correspondencia'>
        <div className='contenedor_registro_correspondencia'>

          <h1>Formulario de registro de Correspondencia</h1>
          ...
          <form onSubmit={guardar_foto}>
            ...
            <div className='divisor_form_correspondencia_1'>
              ...
              <div className="form-group" id="tipo_correspondencia">
                ...
                {(sugerencias.length > 0 && fieldName === "tipo_correspondencia") && (
              ...
              <div className="form-group" id="FechaCorrespondencia">
                ...
                <input
                  type="date"
                  name="fecha_envio"
                  defaultValue={fotografia.fecha_envio ? fotografia.fecha_envio.split('T')[0] : ""}
                  onChange={cambiado}
                />
              </div>
              ...
              <div className="form-group" id="FechaCorrespondencia">
                ...
                <input
                  ...
                  defaultValue={fotografia.fecha_recepcion ? fotografia.fecha_recepcion.split('T')[0] : ""}
                  onChange={cambiado}
                />
              </div>
              ...
              <div className="form-group" id='remitente_correspondencia'>
                ...
                <input type="text"
                  ...
                  name="remitente"
                  placeholder="Autor"
                  value={formulario.remitente || fotografia.remitente}
                  onChange={handleChange} />
                {(sugerencias.length > 0 && fieldName === "remitente") && (
                  <ul className="sugerencias-list">
                    {sugerencias.map((sugerencia, index) => (
                      <li key={index} onClick={() => handleSelect(sugerencia)}>
                        {sugerencia}
              ...
              <div className="form-group" id='destinatario_correspondencia'>
                ...
                <input type="text"
                  ...
                  value={formulario.destinatario || fotografia.destinatario}
                  onChange={handleChange} />
              ...
              <div className="form-group" id='origen_correspondencia' >
                ...
                <input
                  ...
                  value={formulario.lugar_origen || fotografia.lugar_origen}
                  onChange={handleChange}
                />
                {(sugerencias.length > 0 && fieldName === "origen") && (
                  <ul className="sugerencias-list">
                    {sugerencias.map((sugerencia, index) => (
                      <li key={index} onClick={() => handleSelect(sugerencia)}>
                        {sugerencia}
              ...
              <div className="form-group" id='destino_correspondencia' >
                ...
                <input
                  ...
                  value={formulario.lugar_destino || fotografia.lugar_destino}
                  onChange={handleChange}
                />
                {(sugerencias.length > 0 && fieldName === "lugar_destino") && (
                  <ul className="sugerencias-list">
                    {sugerencias.map((sugerencia, index) => (
                      <li key={index} onClick={() => handleSelect(sugerencia)}>
                        {sugerencia}
              ...
              <div className="form-group" id='medio_correspondencia'>
                <label htmlFor="nombreSeudonimos">Medio de envío</label>
                <input
                  type='text'
                  id="nombreSeudonimos"
                  name="medio_envio"
                  value={formulario.medio_envio || fotografia.medio_envio}
                  onChange={handleChange}
                >

                </input>
                {(sugerencias.length > 0 && fieldName === "medio_envio") && (
                  <ul className="sugerencias-list">
                    {sugerencias.map((sugerencia, index) => (
                      <li key={index} onClick={() => handleSelect(sugerencia)}>
                        {sugerencia}
              ...
              <div className="form-group" id="medio_correspondencia">
                ...
                <input
                  ...
                  name="anexos"
                  placeholder="anexos"
                  value={formulario.anexos || fotografia.anexos}
                  onChange={cambiado}
                />
              </div>

              <div className="form-group" id='mensaje_correspondencia'>
                <label>Mensaje</label>
                <input id='encabezado'
                  type="textarea"
                  name="asunto"
                  placeholder=""
                  value={formulario.asunto || fotografia.asunto}
                  onChange={cambiado} />
              </div>
            </div>

            <div className='divisor_form_correspondencia_2'>
              ...
              <div className='divisor_form'>
                <div className="form-group" id="resumen_hemerografia">
                  <p id='resumen_hemerografia_p'>Notas:</p>
                  <textarea
                    type="text"
                    name="notas"
                    placeholder="Resumen"
                    value={formulario.notas || fotografia.notas}
                    onChange={cambiado}
                  />
                ...
                <div className="form-group" id="pendientes_hemerografia">
                  ...
                  <textarea
                    ...
                    name="pendientes"
                    value={formulario.pendientes || fotografia.pendientes}
                    onChange={cambiado}
                  />
                </div>
                <div className='divisor_form'>
                  <div className="form-group" id="transcripcion_hemerografia">
                    ...
                    <textarea
                      ...
                      name="transcripcion"
                      value={formulario.transcripcion || fotografia.transcripcion}
                      onChange={cambiado}
                    />
                  </div>
                </div>
