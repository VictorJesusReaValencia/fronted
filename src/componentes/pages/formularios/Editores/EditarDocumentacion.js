...
export const EditarDocumentacion = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const url = `https://backend-prueba-apel.onrender.com/api/documentacion/listar/todo`;
            try {
    ...
    useEffect(() => {
        const fetchFoto = async () => {
            ...
            if (datos.status === "success") {
                setFotografia(datos.docu); //! ojito aqui
        ...
        <div>
            <main className='main_registro_hemerografia'>
                <div className='contenedor_registro_hemerografia'>
                    <h1>Formulario de edición de Documentación  </h1>
                        ...
                        <div className='divisor_form_documentacion_1'>
                            ...
                            <div className="form-group" id='tipo_documentacion'>
                                ...
                                <input type="text"
                                    ...
                                    value={formulario.tipo_documento || fotografia.tipo_documento}
                                    autoComplete="off"
                                    onChange={handleChange} />
                            ...
                            <div className="form-group" id="fecha_corresponencia_documentacion">
                                ...
                                <input
                                    type="date"
                                    name="vigencia"
                                    defaultValue={fotografia.vigencia ? fotografia.vigencia.split('T')[0] : ""}
                                    onChange={cambiado}
                                />
                            </div>
                            ...
                            <div className="form-group" id='lugar_emision_documentacion' >
                                ...
                                <input
                                    ...
                                    value={formulario.lugar_emision || fotografia.lugar_emision}
                                    autoComplete="off"
                                    onChange={handleChange}
                                />
                            ...
                            <div className="form-group" id='institucion_emision_documentacion'>
                                ...
                                <input
                                    ...
                                    value={formulario.institucion_emisor || fotografia.institucion_emisor}
                                    autoComplete="off"
                                    onChange={handleChange} />
                            ...
                            <div className="form-group" id='emisior_documentacion'>
                                ...
                                <input type="text"
                                    name="emisor"
                                    placeholder=""
                                    value={formulario.emisor || fotografia.emisor}
                                    onChange={handleChange} />
                            ...
                            <div className='form-group' id='fecha_emision_documentacion'>
                                ...
                                <input
                                    type="date"
                                    name="fecha_emision"
                                    defaultValue={fotografia.fecha_emision ? fotografia.fecha_emision.split('T')[0] : ""}
                                    onChange={cambiado}
                                />
                            ...
                            <div className="form-group" id="notas_documentacion">
                                ...
                                <input
                                    ...
                                    value={formulario.notas_relevantes || fotografia.notas_relevantes}
                                    onChange={cambiado}
                                />
                            </div>
                            ...
                            <div className="form-group" id="numero_documentacion">
                                ...
                                <input
                                    ...
                                    value={formulario.numero_expediente || fotografia.numero_expediente}
                                    onChange={cambiado}
                                />
                            </div>
