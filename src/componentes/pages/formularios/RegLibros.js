...
export const RegLibros = () => {
    ...
    const guardar_foto = async (e) => {
        ...
        if (datos.status === "success") {
            ...
            const pdfSubida2 = await Api(`https://backend-prueba-apel.onrender.com/api/libros/registrar-pdf/${datos.publicacionGuardada._id}`, "POST", pdfFormData, true);
            ...
            <main className='main_registro_libros'>
                <div className='contenedor_registro_libros'>
                    ...
                    <form onSubmit={guardar_foto}>
                        ...
                        <div className='divisor_form_libros_3'>
