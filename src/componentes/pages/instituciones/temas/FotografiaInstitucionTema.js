...
export const FotografiaInstitucionTema = () => {
  ...
  const getFotos = async () => {
    const url = `https://backend-prueba-apel.onrender.com/api/fotografia/${institucionId}/${tema}`;
  ...
  const handleEditClick = (event, fotografiaId) => {
    event.stopPropagation();
    navigate(`/admin/editar/fotografias/${fotografiaId}`);
  };
